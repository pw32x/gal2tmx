...
namespace gal2tmx
{
    class BitmapUtils
    {
        static public unsafe Bitmap PackTilesetBitmap(List<Tile> tiles, int tilesAcross, int tileWidth, int tileHeight)
        {
        ...
        internal static Bitmap PackAnimatedTilesetBitmap(List<Tile> tiles, int tileWidth, int tileHeight)
        {
            // tiles are stored
            // 0, 1,  4, 5,   8, 9
            // 2, 3,  6, 7,  10, 11
